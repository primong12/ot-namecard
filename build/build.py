...
# 남은 토큰이 없는지 검증
for token in ("<!--SHIM_SCRIPT-->", "<!--JSZIP_SCRIPT-->", "<!--FACEAPI_SCRIPT-->", "__FONT_SRC__", "__FONT_BOLD__", "__FONT_SEMIBOLD__", "__TAG_SRC__", "__LOGO_SRC__", "__FONT_SCRIPT__", "__BG_LANYARD__", "__BG_1__", "__BG_2__", "__BG_3__", "__BG_4__", "__BG_GUEST__", "__BG_STAFF__", "__BG_STAND__"):
    if token in html:
