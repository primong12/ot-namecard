...
# 8) 스탠드 이름표 배경(가로) data URL 내장 — 파랑=기수, 초록=게스트
html = html.replace("__BG_STAND_BLUE__",  f"data:image/png;base64,{read_b64('assets/bg_stand_blue.png')}")
html = html.replace("__BG_STAND_GREEN__", f"data:image/png;base64,{read_b64('assets/bg_stand_green.png')}")

# 남은 토큰이 없는지 검증
for token in ("<!--SHIM_SCRIPT-->", "<!--JSZIP_SCRIPT-->", "<!--FACEAPI_SCRIPT-->", "__FONT_SRC__", "__FONT_BOLD__", "__FONT_SEMIBOLD__", "__TAG_SRC__", "__LOGO_SRC__", "__FONT_SCRIPT__", "__BG_LANYARD__", "__BG_1__", "__BG_2__", "__BG_3__", "__BG_4__", "__BG_GUEST__", "__BG_STAFF__", "__BG_STAND_BLUE__", "__BG_STAND_GREEN__"):
    if token in html:
